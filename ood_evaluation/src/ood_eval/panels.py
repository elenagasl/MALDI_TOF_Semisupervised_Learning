...
def labeled_indices_for_antibiotic(amr: np.ndarray, sample_idx: np.ndarray, antibiotic_idx: int) -> np.ndarray:
    sample_idx = np.asarray(sample_idx)
    return sample_idx[~np.isnan(amr[sample_idx, antibiotic_idx])]
