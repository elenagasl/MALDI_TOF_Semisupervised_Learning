"""
MALDI-TOF Spectrum Data Structure
===================================

Defines the core SpectrumObject class used throughout this project to represent
a single MALDI-TOF mass spectrum as a pair of aligned 1-D NumPy arrays
(m/z positions and intensity values).

Supports loading from:
    - Direct NumPy array assignment
    - Tab-separated plain-text files (.txt / .tsv) produced by Bruker systems
    - Raw Bruker binary format (.fid / .acqu) directories

The class is the atomic unit passed through the preprocessing pipeline
