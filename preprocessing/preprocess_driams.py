...
from dataloader.driams_dataset import DRIAMS_Manager, DRIAMS
...
def collect_species(dataset_path, preprocess_pipeline, species_list, logger,
    ...
    for i in tqdm(range(len(dataset)), desc="Extracting spectra"):
        ...
        # 🔥 NUEVO: añadir hospital_id
        meta["hospital_id"] = hospital_map.get(meta["hospital"], -1)
